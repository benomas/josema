...
CREATE TABLE `ci_resumen_inventario` (
  ...
  `airtex` VARCHAR(100) NULL,
  `carter` VARCHAR(100) NULL,
  `kem` VARCHAR(100) NULL,
  `walbro` VARCHAR(100) NULL,
  `pfp` VARCHAR(100) NULL,
  `delphi` VARCHAR(100) NULL,
  `std` VARCHAR(100) NULL,
  `wells` VARCHAR(100) NULL,
  `tomco` VARCHAR(100) NULL,
  `transpo` VARCHAR(100) NULL,
  `wai` VARCHAR(100) NULL,
  `bosch` VARCHAR(100) NULL,
  `unipoint` VARCHAR(100) NULL,
  `interfil` VARCHAR(100) NULL,
  `oe_otro` VARCHAR(100) NULL,
